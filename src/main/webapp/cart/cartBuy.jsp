...
<div align="center">
<h3>구매 정보</h3>
<form:form action="../cart/Cartbuy.html" modelAttribute="order" onSubmit="return validate(this)">
...
<table border="1" width="30%">
	<tr>
		...
		<td align="center">${item.quantity * item.price }원</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="center">${item.quantity * item.price + 500}원</td>
	</tr>
