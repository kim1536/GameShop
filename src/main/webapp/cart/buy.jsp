...
<table border="1" width="50%">
	<tr>
		...
		<td><form:input path="recipient_name" value="${sessionScope.USER.user_name }" size="20"/></td>
	</tr>
	<tr>
		<td align="center" width="120">주소</td>
		<td><form:input path="recipient_address"  value="${sessionScope.USER.address }" size="20"/></td>
	</tr>
	<tr>
